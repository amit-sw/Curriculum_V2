def get_prompt(prompt_name: str) -> str:
    prompts = {
        ...
        "generate_slide_content": """You are an AI assistant that generates presentation slides based on user provided outline.
Create a detailed slide-by-slide structured outline for PowerPoint presentation based on the given outline.
You should including key points and any relevant details that the audience should see on the slides.
This content should not include any presenter notes, time estimates, key takeaways, or discussion about the presentation design.
